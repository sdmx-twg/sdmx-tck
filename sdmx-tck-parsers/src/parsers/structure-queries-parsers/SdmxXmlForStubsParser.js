...
class SdmxXmlForStubsParser {
    static getDetail(structureType, props) {
        if (SdmxXmlForStubsParser.isFull(structureType, props)) {
            return StructureDetail.Full;
        } else if (SdmxXmlForStubsParser.isCompleteStub(props)) {
...
module.exports = SdmxXmlForStubsParser;