...
class SdmxXmlV21StructureReferencesParser {
    /**
    ...
    static getReferences(sdmxJsonObject) {
        ...
        for (let i in references) {
            if (references[i] && references[i][0] && references[i][0].$) {
                try {
                    let structureRef = SdmxXmlV21StructureReferencesParser._getStructureReference(references[i][0].$,paths[i]);
    ...
    static _getStructureReference(ref,paths) {
...
module.exports = SdmxXmlV21StructureReferencesParser;