...
var SdmxXmlV21AttributeRelationshipParser = require('./SdmxXmlV21AttributeRelationshipParser.js')
var DataStructureAttributeObject = require('sdmx-tck-api').model.DataStructureAttributeObject;

class SdmxXmlV21DsdComponentParser {
    /**
    ...
    static getComponents(sdmxJsonObject) {
        ...
        for(let i in dimensions){
            ...
            let dimension = new DataStructureComponentObject(
                ...
                SdmxXmlV21StructureReferencesParser.getReferences(dimensions[i]),
        ...
        for(let i in timeDimensions){
            ...
            datastructureComponents.push(
                new DataStructureComponentObject(
                    ...
                    SdmxXmlV21StructureReferencesParser.getReferences(timeDimensions[i]),
        ...
        for(let i in attributes){
            ...
            datastructureComponents.push(
                new DataStructureAttributeObject(
                    ...
                    SdmxXmlV21StructureReferencesParser.getReferences(attributes[i]),
                    SdmxXmlRepresentationParser.getRepresentation(attributes[i]),
                    SdmxXmlV21AttributeRelationshipParser.getAttributeRelationship(attributes[i]),
                    assignmentStatus))
        ...
        for(let i in primaryMeasure){
            ...
            datastructureComponents.push(
                new DataStructureComponentObject(
                    ...
                    SdmxXmlV21StructureReferencesParser.getReferences(primaryMeasure[i]),
                    SdmxXmlRepresentationParser.getRepresentation(primaryMeasure[i])))
        ...
        for(let i in measureDimension){
            ...
            datastructureComponents.push(
                new DataStructureComponentObject(
                    ...
                    SdmxXmlV21StructureReferencesParser.getReferences(measureDimension[i]),
                    SdmxXmlRepresentationParser.getRepresentation(measureDimension[i])))
...
module.exports = SdmxXmlV21DsdComponentParser;