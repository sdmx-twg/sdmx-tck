...
class SdmxV30StructuresParser {
    ...
    static parseStructures(sdmxJsonObjects) {
        ...
        if (sdmxJsonObjects && sdmxJsonObjects.Structure && sdmxJsonObjects.Structure.Structures[0]) {
            ...
            SdmxV30StructuresParser.parseGeographicCodelists(structures, s);
            SdmxV30StructuresParser.parseGeoGridCodelists(structures, s);
            ...
            SdmxV30StructuresParser.parseRegistrations(structures, s);
        }
        return structures;
    };
        ...
        if (s.QueryResult) {
            ...
            for (let i in queryResults) {
                ...
                if (dataResult) {
                    ...
                    let children = SdmxV30StructureReferencesParser.getReferences(registration);
                    //TODO: check this
                    if (children.length == 0) {
                        children = SdmxV21StructureReferencesParser.getReferences(registration);
                    }
