var SdmxV30StructureReferencesParser = require('../structure-queries-parsers/SdmxV30StructureReferencesParser.js');
    ...
    static getStructureData (sdmxJsonObject){   
        ...
        if(sdmxJsonObject.Structure){
            for (let i in sdmxJsonObject.Structure){
                ...
                structureData.push(new HeaderStructureObject(structureID,SdmxV30StructureReferencesParser.getReferences(sdmxJsonObject.Structure[i]))) 
            }
        }
