import SdmxV21JsonParser from '../parsers/SdmxV21JsonParser';
import { isDefined } from '../utils/Utils';
import SDMX_STRUCTURE_TYPE from '../constants/SdmxStructureType';

export default class SdmxObjects {
	constructor(sdmxJsonObjects) {
		this.sdmxJsonObjects = sdmxJsonObjects;
		
		this.structures = SdmxV21JsonParser.parseStructures(this.sdmxJsonObjects);
	}
	getSdmxObjects() {
