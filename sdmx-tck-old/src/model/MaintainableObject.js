...
import SdmxV21JsonForStubsParser from "../parsers/SdmxV21JsonForStubsParser";
import StructureDetail from '../constants/StructureDetail'

class MaintainableObject {
    constructor(structureType, props, children) {
        ...
        this.detail = SdmxV21JsonForStubsParser.getDetail(structureType, props);
    };
    getStructureType() {
...
export default MaintainableObject;