...
## sdmx-tck-modules v5.3.0 (2025-08-27)
- Introduce two new profiles ("Minimum API" and "Data Discovery API") and define the structure tests to be included in each profile.
- Include the selected request mode in the exported reports.
