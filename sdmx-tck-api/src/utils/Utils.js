...
function isSpecificProviderAgency(query) {
    return isDefined(query.providerAgency) && query.providerAgency !== "*";
};
function isSpecificProviderId(query) {
    return isDefined(query.providerId) && query.providerId !== '*';
}
...
module.exports = {
    ...
    isSpecificProviderAgency: isSpecificProviderAgency,
    isSpecificProviderId: isSpecificProviderId,
