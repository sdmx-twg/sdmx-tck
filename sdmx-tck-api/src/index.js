...
const SdmxMessageFormat = require('./constants/SdmxMessageFormat.js');
const TckVersion = require('./constants/TCKVersion.js');
const ExportFormats = require('./constants/ExportFormats.js')
...
const TestRequestMode = require('./constants/TestRequestMode.js');
...
var AnnotationObject = require('./model/structure-queries-models/AnnotationObject.js')
...
module.exports = {
    constants: {
        ...
        EXPORT_FORMATS:ExportFormats.EXPORT_FORMATS,
        API_VERSIONS: ApiVersions.API_VERSIONS,
        SDMX_MESSAGE_FORMAT: SdmxMessageFormat.SDMX_MESSAGE_FORMAT,
        ...
        TEST_REQUEST_MODE: TestRequestMode.TEST_REQUEST_MODE,
