...
class DataTestsExecutionManager {
    static async executeTest(toRun, apiVersion, endpoint) {
        ...
        try {
            ...
            let flow = toRun.identifiers.agency.concat(","+toRun.identifiers.id.concat("," +toRun.identifiers.version));
            let preparedRequest = await DataRequestBuilder.prepareRequest(endpoint, apiVersion,toRun.reqTemplate,flow,undefined,undefined,undefined,undefined);
