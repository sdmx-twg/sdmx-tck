        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                */
                ...
                request.key = DataRequestPropsBuilder.getKey(toRun.apiVersion, toRun.randomKeys, toRun.dsdObj, toRun.reqTemplate);
                ...
                if (!representation) {
                    if (toRun.testType !== TEST_TYPE.DATA_AVAILABILITY) {
                        representation = DATA_QUERY_REPRESENTATIONS.getRepresentation(format);
                    } else {
                        representation = STRUCTURE_QUERY_REPRESENTATIONS.getRepresentation(format);
                    }
                }
